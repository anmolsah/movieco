  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[2/3] overflow-hidden">
        {!imageError ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center">
            <div className="text-center text-slate-400">
              <Tv className="w-8 h-8 sm:w-12 sm:h-12 mx-auto mb-1 sm:mb-2" />
        ...
        {/* TV Show Badge - Hidden on mobile to save space */}
        <div className="hidden sm:block absolute top-3 right-12 bg-blue-600/80 backdrop-blur-sm px-2 py-1 rounded-full">
      ...
      {/* TV Show Info - Minimal on mobile, detailed on desktop */}
        ...
        <div className="sm:hidden">
          ...
          <div className="flex items-center justify-between">
            <span className="text-xs text-slate-400">
              {formatDate(tvShow.first_air_date).split(",")[0]}
            </span>
          ...
          <div className="flex items-center justify-between mt-3">
            <div className="flex items-center gap-1 text-slate-400">
              ...
              <span className="text-xs">
                {tvShow.popularity?.toFixed(0)} views
              </span>
            </div>
