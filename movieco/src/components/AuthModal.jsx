      ...
      <div className="bg-slate-900 rounded-2xl max-w-md w-full p-8 relative max-h-[90vh] overflow-y-auto">
        ...
        {mode !== 'forgot' && (
          <button
            ...
            disabled={loading}
            className="w-full bg-white hover:bg-gray-100 text-gray-900 font-semibold py-3 px-6 rounded-xl flex items-center justify-center gap-3 transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 mb-6"
          >
            {loading ? (
